(function() {
    ...
    function Notifier(user_options) {
        ...
        // If we're on mobile or tablet, we want to
        // Set options.closeTime to 0
        ...
        let createNotification = (notification_text) => {
            ...
            // Set the timeout for the close method
    ...
    if ("Notification" in window) {
        ...
        // Trigger the action on the click event of action_button
